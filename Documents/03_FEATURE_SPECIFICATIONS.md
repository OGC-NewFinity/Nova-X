...
⚙️ **Execution Model:** Prompt → Production (Zero Manual Steps)
...
## 🏗️ Module 1 — **THE ARCHITECT (Design Engine)**
...
## ✍️ Module 2 — **THE SCRIBE (Content Engine)**
...
## 🖼️ Module 3 — **MEDIA LAB (Visual Engine)**
...
|------|------------|----------------|
| **Image Forge** | Generates photorealistic or vector visuals via DALL·E 3 | `class-nova-x-openai.php` |
...
## ⚙️ Module 4 — **THE PULSE (Monitoring & Control)**
